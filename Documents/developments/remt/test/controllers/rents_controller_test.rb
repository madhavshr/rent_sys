...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { contact: @rent.contact, location: @rent.location, owner_name: @rent.owner_name, price: @rent.price, type: @rent.type }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { contact: @rent.contact, location: @rent.location, owner_name: @rent.owner_name, price: @rent.price, type: @rent.type }
    assert_redirected_to rent_path(assigns(:rent))
  end
